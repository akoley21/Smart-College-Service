...
$pass=$_POST['pass'];
$obj=new Crud();
$sql="SELECT * FROM signup WHERE email='".$email."' AND pass='".$pass."' AND status='done'" ;
$res=$obj->login($sql);
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="login.php" class="login100-form validate-form" method="post">
					...
					<strong> Email id or Password not Match</strong>	
					</div>
